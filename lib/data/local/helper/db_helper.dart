...
class DBHelper{
  ...
  Future<Database> openDB() async{
    ...
    return await openDatabase(dbPath, version: 1, onCreate: (db, version){
      ...
      db.execute("CREATE TABLE $TABLE_EXPENSE ($COLUMN_EXPENSE_ID INTEGER PRIMARY KEY AUTOINCREMENT, $COLUMN_EXPENSE_TITLE TEXT, $COLUMN_EXPENSE_DESC TEXT, $COLUMN_EXPENSE_AMOUNT INTEGER, $COLUMN_EXPENSE_BAL INTEGER, $COLUMN_EXPENSE_CREATED_AT TEXT, $COLUMN_EXPENSE_CAT_ID INTEGER, $COLUMN_EXPENSE_TYPE TEXT)");
